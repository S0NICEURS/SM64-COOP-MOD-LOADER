...
# URL du fichier ZIP
url = "https://archive.org/download/mods-sm64-coop/king-in-coop-v2_by_king_the_memer.zip"
...
download_path = os.path.join(mods_path, 'king-in-coop-v2_by_king_the_memer.zip')
