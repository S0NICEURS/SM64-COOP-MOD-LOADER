...
# URL de l'image
image_url = "https://i.ibb.co/jr2V23P/sonic-REBOOTED.png"
...
def create_main_window():
    ...
    try:
        ...
        title = tk.Label(root, text="Sonic Character: Rebooted V1.2", font=("Helvetica", 20, "bold"), fg="white", bg="black")
        title.pack(pady=5)

        # Ajouter le texte "Nom de l'auteur"
        author = tk.Label(root, text="By steven3004", font=("Helvetica", 16), fg="white", bg="black")
        author.pack(pady=5)

        # Ajouter le texte "Description du mod"
        description = tk.Label(root, text="command: /sonic on (Mario = Sonic, Toad = Amy)", font=("Helvetica", 12), fg="white", bg="black", wraplength=400)
...
def run_minecraftDL():
    try:
        script_path = os.path.join(os.path.dirname(__file__), 'sonic_rebootedDL.py')
