...
# URL de l'image
image_url = "https://i.ibb.co/LNhV4bh/kingbobomb.png"
...
def create_main_window():
    ...
    try:
        ...
        title = tk.Label(root, text="Brutal Bosses V1", font=("Helvetica", 20, "bold"), fg="white", bg="black")
        title.pack(pady=5)
        ...
        description = tk.Label(root, text="Stronger boss fight", font=("Helvetica", 12), fg="white", bg="black", wraplength=400)
...
def run_minecraftDL():
    try:
        script_path = os.path.join(os.path.dirname(__file__), 'bossDL.py')
        subprocess.run(['python', script_path], check=True)
        print("Le script bossDL.py a été exécuté avec succès.")
    except Exception as e:
        print(f"Erreur lors de l'exécution de bossDL.py : {e}")
