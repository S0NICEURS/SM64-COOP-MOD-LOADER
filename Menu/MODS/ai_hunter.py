...
# URL de l'image
image_url = "https://i.ibb.co/fCcmnqW/ai-hunter.png"
...
def create_main_window():
    ...
    try:
        ...
        title = tk.Label(root, text="AI Hunter (Single Player)", font=("Helvetica", 20, "bold"), fg="white", bg="black")
        title.pack(pady=5)
        ...
        description = tk.Label(root, text="open another instance sm64 coop and go to your room so the mario ai follow you", font=("Helvetica", 12), fg="white", bg="black", wraplength=400)
...
def run_minecraftDL():
    try:
        script_path = os.path.join(os.path.dirname(__file__), 'ai_hunterDL.py')
