...
# URL de l'image
image_url = "https://i.ibb.co/3vv9nCY/speedtime.png"
...
def create_main_window():
    ...
    try:
        ...
        title = tk.Label(root, text="Speedrun Timer Reworked", font=("Helvetica", 20, "bold"), fg="white", bg="black")
        title.pack(pady=5)

        # Ajouter le texte "Nom de l'auteur"
        author = tk.Label(root, text="By JairoThePlumber", font=("Helvetica", 16), fg="white", bg="black")
        author.pack(pady=5)
...
def run_minecraftDL():
    try:
        script_path = os.path.join(os.path.dirname(__file__), 'speedrun_timeDL.py')
