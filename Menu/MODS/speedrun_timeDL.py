...
# URL du fichier ZIP
url = "https://github.com/JairoThePlumber/Speedrun-Timer-Reworked/releases/download/1.2hotfix/Speedrun.Timer.Reworked.zip"
...
download_path = os.path.join(mods_path, 'Speedrun.Timer.Reworked.zip')
