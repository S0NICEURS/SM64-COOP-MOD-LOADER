...
# URL de l'image
image_url = "https://i.ibb.co/Zmjwfyk/309593221-c8268b54-0e61-4558-9c68-6129cc877f56.png"
...
def create_main_window():
    ...
    try:
        ...
        title = tk.Label(root, text="NoClip", font=("Helvetica", 20, "bold"), fg="white", bg="black")
        title.pack(pady=5)

        # Ajouter le texte "Nom de l'auteur"
        author = tk.Label(root, text="By AgentX", font=("Helvetica", 16), fg="white", bg="black")
        author.pack(pady=5)
...
def run_minecraftDL():
    try:
        script_path = os.path.join(os.path.dirname(__file__), 'noclipDL.py')
        subprocess.run(['python', script_path], check=True)
        print("Le script noclipDL.py a été exécuté avec succès.")
    except Exception as e:
        print(f"Erreur lors de l'exécution de noclipDL.py : {e}")
