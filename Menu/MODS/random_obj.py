...
# URL de l'image
image_url = "https://i.ytimg.com/vi/4etA-6X1t60/hq720.jpg?sqp=-…AFwAcABBg==&rs=AOn4CLAynnU7kflyciUlJujcgQl2eNG04Q"
...
def create_main_window():
    ...
    try:
        ...
        title = tk.Label(root, text="Random Objects", font=("Helvetica", 20, "bold"), fg="white", bg="black")
        title.pack(pady=5)
...
def run_minecraftDL():
    try:
        script_path = os.path.join(os.path.dirname(__file__), 'random_objDL.py')
