...
# URL du fichier ZIP
url = "https://archive.org/download/mods-sm64-coop/Minecraft%20%2B%20V1.1%20By%20zKevin%2C%20Code%20D.zip"
...
download_path = os.path.join(mods_path, 'Minecraft + V1.1 By zKevin, Code D.zip')
