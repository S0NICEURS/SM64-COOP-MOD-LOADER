...
# URL du fichier ZIP
url = "https://github.com/stvene3004/sonic-char-rebooted/releases/download/v1.2.2/sonic-char-rebooted.zip"
...
download_path = os.path.join(mods_path, 'sonic-char-rebooted.zip')
