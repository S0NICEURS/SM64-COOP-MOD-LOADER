...
# URL du fichier ZIP
url = "https://archive.org/download/mods-sm64-coop/ai-hunter-%28single-player%29-by-Drenchy.zip"
...
download_path = os.path.join(mods_path, 'ai-hunter-(single-player)-by-Drenchy.zip')
