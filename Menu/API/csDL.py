...
# URL du fichier ZIP
url = "https://github.com/Squishy6094/character-select-coop/releases/download/1.8/character-select-coop.zip"
...
download_path = os.path.join(mods_path, 'character-select-coop.zip')
