...
# URL de l'image
image_url = "https://i.ibb.co/HKJPHzY/cs.png"
...
def create_main_window():
    ...
    try:
        ...
        title = tk.Label(root, text="Character Select V1.8", font=("Helvetica", 20, "bold"), fg="white", bg="black")
        title.pack(pady=5)

        # Ajouter le texte "Nom de l'auteur"
        author = tk.Label(root, text="By Squishy6094", font=("Helvetica", 16), fg="white", bg="black")
        author.pack(pady=5)

        # Ajouter le texte "Description du mod"
        description = tk.Label(root, text="Command: /char-select", font=("Helvetica", 12), fg="white", bg="black", wraplength=400)
