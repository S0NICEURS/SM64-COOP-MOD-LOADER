...
# URL de l'image
image_url = "https://i.ibb.co/kKtR9VP/1720652388941.png"
...
def create_main_window():
    ...
    try:
        ...
        title = tk.Label(root, text="Smash Bross Coop V0.2", font=("Helvetica", 20, "bold"), fg="white", bg="black")
        title.pack(pady=5)

        # Ajouter le texte "Nom de l'auteur"
        author = tk.Label(root, text="By Keeberghrh", font=("Helvetica", 16), fg="white", bg="black")
        author.pack(pady=5)
